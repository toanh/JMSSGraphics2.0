...
class Vector(object):
    ...
    def normalize(self):
        ...
        norm = self.norm()
        normed = [comp / norm for comp in self.values]
    ...
    def __add__(self, other):
        ...
        added = [self.values[i] + other.values[i] for i in range(len(self.values))]
    ...
    def __sub__(self, other):
        ...
        subbed = [self[i] - other[i] for i in range(len(self.values))]
